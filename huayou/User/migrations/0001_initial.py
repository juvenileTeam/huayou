# Generated by Django 2.2.16 on 2020-09-23 17:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('北京', '北京'), ('上海', '上海'), ('深圳', '深圳'), ('成都', '成都'), ('西安', '西安'), ('武汉', '武汉'), ('沈阳', '沈阳')], max_length=32, verbose_name='常居地')),
            ],
            options={
                'db_table': 'user',
            },
